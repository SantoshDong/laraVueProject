        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                  <div class="card card-widget widget-user">
                      ...
                      <img class="widget-user-image" :src="getProfilePhoto()" alt="user Avatar"/>
                    ...
                    <div class="tab-pane active" id="settings">
                      <form class="form-horizontal">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-10">
                            <input type="password" v-model="form.password" class="form-control" id="inputPassport" :class="{ 'is-invalid': form.errors.has('password') }">
    ...
    export default {
      data(){
        ...
        mounted() {
         ...
         methods : {
        getProfilePhoto(){
            let photo = (this.form.photo.length >150) ? this.form.photo : "images/profile/"+this.form.photo;
            return photo;
